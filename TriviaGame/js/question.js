...
let quest2 = new Quiz("Where is the Cerebellum located", ["At Rear of the Brain", "Behind the eyes", "In the Frontal Lobe ", "In the Temporal Lobs"], 0);
...
let quest10 = new Quiz("People with Parkinson's display impairments during what?", ["Sequence taks", "Time events", "How to use their Memory", "All of the Above"], 3);
